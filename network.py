...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        # backward pass
        #Selecciona la función de costo con base a la sigmoide elejido
        delta = 1/len(activations)*self.cost_derivative(activations[-1], y) * \
            sigmoid_prime(zs[-1]) #Aquí aplicamos y modificamos la función de costo, a una cross entropy, con la función len, 
                                   # que es el equivalente a un 1/n de forma iterativa, y calculamos el error de la ultima capa
